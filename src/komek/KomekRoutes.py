...
from .KomekSchemas import KomekCreate, KomekOut, ApplyToRequestCreate, KomekNearbyOut, UserRatingOut, RatingRequest, UserAverageRating
...
@komek_router.get("/users/{user_id}/ratings", response_model=UserAverageRating)
